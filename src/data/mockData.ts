...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  },
  {
    ...
    description: 'LARS-AI Engine memproses foto dengan Computer Vision, menganalisis transkrip suara, dan OCR dokumen.',
    status: 'Completed',
    payloadSample: 'Engine: LARS-AI | Latency: 1.2s | Confidence: 99.4%',
...
export const MOCK_AUDIT_LOGS: AuditLog[] = [
  ...
  },
  {
    ...
    action: 'Upload Foto Computer Vision Bottom Plate MT Ocean Glory (LARS-AI Engine)',
